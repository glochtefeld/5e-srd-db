...
DELETE FROM sqlite_sequence where name='pantheon';
...
DELETE FROM sqlite_sequence where name='alignment';
...
DELETE FROM deity;
DELETE FROM sqlite_sequence where name='deity';
...
DELETE FROM deityDomain;
DELETE FROM sqlite_sequence where name='deityDomain';
