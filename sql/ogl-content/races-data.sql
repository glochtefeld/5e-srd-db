...
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (1, 'Dwarven Combat Training', 'You have proficiency with the battleaxe, handaxe, light hammer, and warhammer.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (1, 'Tool Proficiency', 'You gain proficiency with the artisan’s tools of your choice: smith’s tools, brewer’s supplies, or mason’s tools.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (1, 'Stonecunning', 'Whenever you make an Intelligence (History) check related to the origin of stonework, you are considered proficient in the History skill and add double your proficiency bonus to the check, instead of your normal proficiency bonus.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (2, 'Darkvision', 'Accustomed to twilit forests and the night sky, you have superior vision in dark and dim conditions. You can see in dim light within 60 feet of you as if it were bright light, and in darkness as if it were dim light. You can’t discern color in darkness, only shades of gray.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (2, 'Keen Senses', 'You have proficiency in the Perception skill.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (2, 'Fey Ancestry', 'You have advantage on saving throws against being charmed, and magic can’t put you to sleep.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (2, 'Trance', 'Elves don’t need to sleep. Instead, they meditate deeply, remaining semiconscious, for 4 hours a day. (The Common word for such meditation is “trance.”) While meditating, you can dream after a fashion; such dreams are actually mental exercises that have become reflexive through years of practice.  After resting in this way, you gain the same benefit that a human does from 8 hours of sleep.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (3, 'Lucky', 'When you roll a 1 on the d20 for an attack roll, ability check, or saving throw, you can reroll the die and must use the new roll.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (3, 'Brave', 'You have advantage on saving throws against being frightened.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (3, 'Halfling Nimbleness', 'You can move through the space of any creature that is of a size larger than yours.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (5, 'Draconic Ancestry', 'You have draconic ancestry.  Choose one type of dragon from the Draconic Ancestry table. Your breath weapon and damage resistance are determined by the dragon type, as shown in the table.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (5, 'Damage Resistance', 'You have resistance to the damage type associated with your draconic ancestry.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (6, 'Darkvision', 'Accustomed to life underground, you have superior vision in dark and dim conditions. You can see in dim light within 60 feet of you as if it were bright light, and in darkness as if it were dim light.  You can’t discern color in darkness, only shades of gray.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (6, 'Gnome Cunning', 'You have advantage on all Intelligence, Wisdom, and Charisma saving throws against magic.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (7, 'Darkvision', 'Thanks to your elf blood, you have superior vision in dark and dim conditions. You can see in dim light within 60 feet of you as if it were bright light, and in darkness as if it were dim light.  You can’t discern color in darkness, only shades of gray.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (7, 'Fey Ancestry', 'You have advantage on saving throws against being charmed, and magic can’t put you to sleep.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (7, 'Skill Versatility', 'You gain proficiency in two skills of your choice.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (8, 'Darkvision', 'Thanks to your orc blood, you have superior vision in dark and dim conditions. You can see in dim light within 60 feet of you as if it were bright light, and in darkness as if it were dim light.  You can’t discern color in darkness, only shades of gray.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (8, 'Menacing', 'You gain proficiency in the Intimidation skill.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (8, 'Relentless Endurance', 'When you are reduced to 0 hit points but not killed outright, you can drop to 1 hit point instead. You can’t use this feature again until you finish a long rest.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (8, 'Savage Attacks', 'When you score a critical hit with a melee weapon attack, you can roll one of the weapon’s damage dice one additional time and add it to the extra damage of the critical hit.', NULL);
INSERT INTO raceFeature (raceID, name, description, bc) VALUES (9, 'Darkvision', 'Thanks to your infernal heritage, you have superior vision in dark and dim conditions. You can see in dim light within 60 feet of you as if it were bright light, and in darkness as if it were dim light.  You can’t discern color in darkness, only shades of gray.', NULL);
...
INSERT INTO subraceFeature (subraceID, name, description, bc) VALUES (2, 'Extra Language', 'You can speak, read, and write one extra language of your choice.', NULL);
INSERT INTO subraceFeature (subraceID, name, description, bc) VALUES (3, 'Naturally Stealthy', 'You can attempt to hide even when you are obscured only by a creature that is at least one size larger than you.', NULL);
